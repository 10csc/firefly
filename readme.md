...
- 记忆压缩存档：对话在"休息"时整理进 memory.md（`user_data/{mode}/data/`），起床加载
...
**📦 直接下载（无需构建）**：https://github.com/10csc/firefly/releases

| 平台 | 包 | 说明 |
|------|-----|------|
| Windows | `firefly-setup.exe` | **一键安装**，装完桌面/开始菜单有快捷方式，双击即启动 |
